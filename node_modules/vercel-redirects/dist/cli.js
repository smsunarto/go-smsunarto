...
program.command('add <destination> [source]', {
  isDefault: true
}).description('Add a new redirect. Short url is created for you if you dont provide a source.').option('-c, --status-code <code>', 'HTTP status code. Must be a value between 301-308.', parseStatusCode).action(add);
